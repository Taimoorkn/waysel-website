...
export const customSoftwareDevFaqs = [
  ...
  },
  {
    ...
    answer: "Timelines range from 3-6 months depending on complexity, with regular milestones to keep you informed.",
  },
  {
    question: "DO YOU PROVIDE MAINTENANCE FOR CUSTOM SOFTWARE?",
    answer: "Yes, we offer ongoing maintenance and updates to keep your custom software performing optimally.",
  },
];
...
export const chromeExtensionDevFaqs = [
  ...
  },
  {
    ...
    answer: "We follow a cycle of design, coding with HTML/CSS/JS, testing, and submission to the Chrome Web Store.",
  },
  {
    question: "DO YOU OFFER SUPPORT AFTER EXTENSION LAUNCH?",
    answer: "Yes, we provide updates and support to address bugs or feature requests post-launch.",
  },
];

export const ecommerceDevFaqs = [
  {
    question: "WHAT ECOMMERCE PLATFORMS DO YOU SUPPORT?",
    answer: "We work with Shopify, WooCommerce, and Magento, delivering robust online store solutions.",
  },
  {
    question: "HOW DO YOU ENSURE ECOMMERCE SECURITY?",
    answer: "We implement SSL, payment gateway security, and regular audits to protect transactions and customer data.",
  },
  {
    question: "CAN YOU INTEGRATE PAYMENT GATEWAYS?",
    answer: "Yes, we integrate gateways like PayPal, Stripe, and others to ensure seamless payment processing.",
  },
  {
  ...
  },
  {
    ...
    answer: "A basic site takes 4-8 weeks, with complex stores requiring 10-12 weeks, depending on customization.",
  },
  {
    question: "DO YOU PROVIDE POST-LAUNCH ECOMMERCE SUPPORT?",
    answer: "Yes, we offer maintenance, updates, and SEO optimization to keep your store competitive.",
  },
];
...
export const digitalMarketingFaqs = [
  {
    ...
    answer: "We provide SEO, PPC, social media marketing, and content creation to boost your online presence.",
  },
  {
    question: "HOW DO YOU MEASURE THE SUCCESS OF MARKETING CAMPAIGNS?",
    answer: "We track KPIs like click-through rates, conversions, and ROI using tools like Google Analytics.",
  },
  {
    question: "CAN YOU CREATE CONTENT FOR MARKETING?",
    answer: "Yes, we produce blogs, videos, and infographics tailored to your brand and audience.",
  },
  {
    question: "HOW LONG DOES IT TAKE TO SEE RESULTS FROM MARKETING?",
    answer: "Results vary; SEO may take 3-6 months, while PPC can show immediate impact with proper optimization.",
  },
  {
    question: "DO YOU OFFER LOCALIZED MARKETING STRATEGIES?",
    answer: "Yes, we tailor campaigns for specific regions, using localized keywords and cultural insights.",
  },
];

export const customDevFaqs = [
  {
    question: "WHAT PLATFORMS AND TECHNOLOGIES DO YOU USE FOR CUSTOM SOFTWARE?",
    answer:
      "We leverage a variety of platforms and technologies such as .NET, Java, Python, and Docker, tailoring the stack to your specific project requirements for optimal performance.",
  },
  {
    question: "HOW DO YOU ENSURE THE SECURITY OF CUSTOM SOFTWARE?",
    answer:
      "We implement robust security measures including encryption, secure APIs, and regular audits to safeguard your custom software and sensitive data.",
  },
  {
    question: "WHAT IS YOUR APPROACH TO CUSTOM SOFTWARE DESIGN?",
    answer:
      "We prioritize scalable and user-focused design, collaborating with you to create prototypes and refine solutions based on your feedback and business needs.",
  },
  {
    question: "HOW LONG DOES IT TAKE TO DEVELOP CUSTOM SOFTWARE?",
    answer:
      "Development time depends on complexity, but we typically deliver initial solutions in 10-16 weeks using Agile methodologies and iterative development.",
  },
  {
    question: "DO YOU PROVIDE ONGOING SUPPORT FOR CUSTOM SOFTWARE?",
    answer:
      "Yes, we offer continuous support, including updates, bug fixes, and feature enhancements to ensure your software evolves with your business.",
  },
];
...
export const eCommerceDevFaqs = [
  {
    ...
    answer:
      "We support platforms like Shopify, WooCommerce, Magento, and custom-built solutions, tailoring each to your business model and scalability needs.",
  },
  {
    question: "HOW DO YOU ENSURE E-COMMERCE SECURITY?",
    answer:
      "We implement SSL encryption, PCI compliance, and secure payment gateways to protect customer data and transactions on your e-commerce site.",
  },
  {
    question: "WHAT IS YOUR APPROACH TO E-COMMERCE DESIGN?",
    answer:
      "We focus on user-friendly, conversion-optimized designs, conducting A/B testing and UX research to enhance customer engagement and sales.",
  },
  {
    question: "HOW LONG DOES IT TAKE TO BUILD AN E-COMMERCE SITE?",
    answer:
      "Development time varies by complexity, but we typically deliver functional e-commerce sites in 6-10 weeks using Agile methodologies and client input.",
  },
  {
    question: "DO YOU OFFER SUPPORT FOR E-COMMERCE SOLUTIONS?",
    answer:
