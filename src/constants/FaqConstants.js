...
export const customSoftwareDevFaqs = [
  ...
  },
  {
    ...
    answer:
      "Timelines range from 3-6 months depending on complexity, with regular milestones to keep you informed.",
  },
  {
    question: "DO YOU PROVIDE MAINTENANCE FOR CUSTOM SOFTWARE?",
    answer:
      "Yes, we offer ongoing maintenance and updates to keep your custom software performing optimally.",
  },
];
...
export const chromeExtensionDevFaqs = [
  ...
  },
  {
    ...
    answer:
      "We follow a cycle of design, coding with HTML/CSS/JS, testing, and submission to the Chrome Web Store.",
  },
  {
...
export const ecommerceDevFaqs = [
  {
    ...
    answer:
      "We work with Shopify, WooCommerce, and Magento, delivering robust online store solutions.",
  },
  {
    question: "HOW DO YOU ENSURE ECOMMERCE SECURITY?",
    answer:
      "We implement SSL, payment gateway security, and regular audits to protect transactions and customer data.",
  },
  {
    question: "CAN YOU INTEGRATE PAYMENT GATEWAYS?",
    answer:
      "Yes, we integrate gateways like PayPal, Stripe, and others to ensure seamless payment processing.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A basic site takes 4-8 weeks, with complex stores requiring 10-12 weeks, depending on customization.",
  },
  {
    question: "DO YOU PROVIDE POST-LAUNCH ECOMMERCE SUPPORT?",
    answer:
      "Yes, we offer maintenance, updates, and SEO optimization to keep your store competitive.",
  },
];
...
export const digitalMarketingFaqs = [
  {
    ...
    answer:
      "We provide SEO, PPC, social media marketing, and content creation to boost your online presence.",
  },
  {
    question: "HOW DO YOU MEASURE THE SUCCESS OF MARKETING CAMPAIGNS?",
    answer:
      "We track KPIs like click-through rates, conversions, and ROI using tools like Google Analytics.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Results vary; SEO may take 3-6 months, while PPC can show immediate impact with proper optimization.",
  },
  {
    question: "DO YOU OFFER LOCALIZED MARKETING STRATEGIES?",
    answer:
      "Yes, we tailor campaigns for specific regions, using localized keywords and cultural insights.",
  },
];
