...
const ContactItem = ({ icon: Icon, title, details }) => (
  <div className="flex items-center space-x-4 sm:space-x-6 group">
    ...
    <div className="flex-1">
      {title && (
        <h3 className="font-manrope text-sm sm:text-base leading-[21.9px] text-primary_text font-medium">
          {title}
        </h3>
      )}
      <p className="font-manrope text-sm sm:text-base leading-[21.9px] text-secondary_text">
        {details}
      </p>
    </div>
  </div>
  ...
  return (
    <section className="bg-primary_bg px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-[9.5rem] py-6 sm:py-8 md:py-10">
      <div className="text-center mb-8">
        <div className="font-manrope inline-flex items-center bg-blue-50 text-accent px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6 transition-all hover:bg-blue-100">
      ...
      <div className="  mx-auto">
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-2/6 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            <h3 className="font-clashGrotesk text-2xl font-semibold mb-6 text-primary_text">
              Get in Touch
            </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-6 sm:space-y-0">
                  <div className="w-full sm:w-1/2">
                    <label
                      htmlFor="name"
                      className="font-medium text-sm sm:text-base leading-[21.9px] text-gray-900 mb-2 block"
                    >
                      Name
                    </label>
