...
const GoalsVision = () => {
 ...
 <h3 className="text-xl sm:text-2xl font-bold text-blue-600 font-neueMontreal">
 Our Goals
 </h3>
 </div>
 <h4 className="font-neueMontreal text-xl sm:text-2xl lg:text-[32px] font-semibold text-primary_text mb-4 sm:mb-6">
 To upscale your business to a higher level
 </h4>
 <p className="text-secondary_text font-neueMontreal text-sm sm:text-base lg:text-lg">
 ...
 <Link
 href={"/contact"}
 className="mt-4 sm:mt-6 flex items-center text-accent font-neueMontreal font-semibold text-sm sm:text-base group-hover:translate-x-2 transition-transform"
 >
 ...
 <h3 className="text-xl sm:text-2xl font-bold text-accent font-neueMontreal">
 Our Vision
 </h3>
 </div>
 <h4 className="font-neueMontreal text-xl sm:text-2xl lg:text-[32px] font-semibold text-primary_text mb-4 sm:mb-6">
