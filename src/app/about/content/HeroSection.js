...
const HeroSection = () => {
 ...
 <span className="text-white text-xs sm:text-sm font-medium font-neueMontreal">
 Building Things, One Solution at a Time
 </span>
 </div>

 <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[72px] font-neueMontreal font-semibold mb-4 sm:mb-6 text-white bg-clip-text text-transparent">
 ...
 <p className="text-base sm:text-lg lg:text-xl text-secondary_bg mb-8 sm:mb-10 lg:mb-12 max-w-3xl mx-auto font-neueMontreal">
 ...
 <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center font-neueMontreal">
