...
const TestimonialCard = ({ quote, name, role, image, isActive }) => {
 ...
 <p className="text-tertiary_text w-full font-neueMontreal text-sm sm:text-base">
 "{quote}"
 </p>
 ...
 />
 <div>
 <h3 className="font-neueMontreal font-medium text-lg sm:text-xl mb-1 text-primary_text">
 {name}
 </h3>
 <p className="font-neueMontreal text-xs sm:text-sm text-primary_text">
 {role}
 </p>
 </div>
 </div>
