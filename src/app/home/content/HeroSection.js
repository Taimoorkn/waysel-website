...
const HeroSection = () => {
 ...
 <p className="font-neueMontreal text-white 2xl:text-primary_text font-medium text-[10px] 3xl:text-sm">
 All good stories deserve embellishment - Gandalf the Grey
 </p>
 <span className="text-white 2xl:text-primary_text font-normal font-neueMontreal text-4xl xl:font-semibold xl:text-[54px] 3xl:text-[64px]">
 We are a{" "}
 ...
 <p className="mt-4 font-neueMontreal text-white 2xl:text-primary_text font-medium text-sm xl:text-lg">
