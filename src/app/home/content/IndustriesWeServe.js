...
const IndustriesWeServe = () => {
 ...
 <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 border-l border-t border-gray-200">
 {industries.map((industry, index) => {
 const [isHovered, setIsHovered] = useState(false);
 return (
 <div
 key={index}
 className="flex flex-col items-center justify-center text-center border-r border-b border-gray-200 px-4 py-12 hover:bg-gray-50"
 ...
 <h3 className="text-primary_text font-neueMontreal text-xs xl:text-base font-medium">
 {industry.name}
 </h3>
 </div>
 );
