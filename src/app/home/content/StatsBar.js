...
const StatsBar = () => {
 ...
 >
 <div className="font-neueMontreal text-white flex flex-col items-start sm:items-center lg:items-start flex-1 sm:flex-none lg:flex-1">
 <p className="font-semibold text-xl sm:text-2xl lg:text-[2rem]">
 {stat.value}
 </p>
 <p className="font-medium text-xs sm:text-sm lg:text-sm sm:text-center lg:text-left mt-1">
 {stat.label}
 </p>
 </div>
