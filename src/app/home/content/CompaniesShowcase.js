...
const CompaniesShowcase = () => {
 ...
 <SwiperSlide
 key={index}
 className="relative custom-dashed-border !flex !items-center !justify-center !h-[60px] lg:!h-[100px]"
 >
 <img
 src={item.image}
 alt="Company logo"
 ...
 />
 <div className="absolute left-0 top-[20%] bottom-[20%] w-[0.5px] bg-tertiary_text" />
 </SwiperSlide>
 ))}
 </Swiper>
 </div>
