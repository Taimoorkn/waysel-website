export const metadata = {
  ...
  description:
    "Professional mobile app development for iOS and Android. Build native and cross-platform mobile applications with expert developers.",
  keywords: [
  ...
  twitter: {
    ...
    title: "Mobile App Development Services - TechiTech Solutions",
    description:
      "Professional mobile app development for iOS and Android. Build native and cross-platform mobile applications.",
