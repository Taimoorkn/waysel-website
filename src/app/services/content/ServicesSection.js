  ...
  return (
    <section className="bg-secondary_bg py-6 sm:py-8 px-4 sm:px-6 lg:px-8 2xl:px-[9.5rem]">
      ...
      <div className="text-center mb-6 sm:mb-8 lg:mb-10">
        <div className="font-manrope inline-flex items-center bg-blue-100 text-accent px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4">
          <StarFourIcon weight="fill" className="w-4 h-4 mr-2" />
          Our Technology Services
        </div>
        <h2 className="font-clashGrotesk text-3xl sm:text-4xl lg:text-5xl font-semibold mb-3 sm:mb-4 text-primary_text">
          ...
          >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <h3 className="font-clashGrotesk text-lg font-semibold leading-tight">
                          {service.title}
                        </h3>
            ...
            <AccordionBody className="px-0 py-0">
              <div className="bg-white p-4 space-y-4">
                <p className="font-manrope text-sm text-secondary_text leading-relaxed">
                  {service.description}
                </p>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-clashGrotesk text-base font-semibold text-primary_text mb-3 flex items-center gap-2">
                    ...
                    <div className="space-y-2">
                      {service.features.map((feature, idx) => (
                        <div key={idx} className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg">
                          ...
                          <span className="font-manrope text-xs font-medium text-secondary_text">
                            {feature}
                          </span>
                        </div>
                      ))}
                      ...
                      {service.benefits.map((benefit, idx) => (
                        <div key={idx} className="p-2 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="font-manrope text-xs font-semibold text-primary_text">{benefit.title}</span>
                          </div>
                          <p className="font-manrope text-xs text-secondary_text ml-7">
                            {benefit.desc}
                          </p>
                        </div>
                      ))}
          ...
          <div className="xl:w-1/3">
            <div className="bg-white rounded-2xl shadow-xl p-6 sticky top-8 border border-gray-50">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-clashGrotesk text-xl font-semibold text-primary_text">
                    Choose Service
                  </h3>
                  <p className="font-manrope text-sm text-secondary_text">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-50">
              ...
              <div className={`relative p-6 text-white overflow-hidden bg-gradient-to-br ${services[selectedService].gradient}`}>
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="font-clashGrotesk text-3xl lg:text-4xl font-semibold mb-4 leading-tight">
                    {services[selectedService].title}
                  </h3>
                  <p className="font-manrope text-base opacity-90 leading-relaxed max-w-2xl">
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                  <div>
                    <h4 className="font-clashGrotesk text-lg font-semibold text-primary_text mb-4 flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                      {services[selectedService].features.map((feature, index) => (
                        <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200 group">
                          ...
                          <span className="font-manrope font-medium text-sm text-secondary_text group-hover:text-primary_text transition-colors duration-200">
                            {feature}
                          </span>
                        </div>
                      ))}
                      ...
                      {services[selectedService].benefits.map((benefit, index) => (
                        <div key={index} className="p-3 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="font-manrope font-semibold text-sm text-primary_text">{benefit.title}</span>
                          </div>
                          <p className="font-manrope text-xs text-secondary_text ml-8">
                            {benefit.desc}
                          </p>
                        </div>
                      ))}
