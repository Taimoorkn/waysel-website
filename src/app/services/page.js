...
export const metadata = {
  ...
  description:
    "Explore our comprehensive software development services including web development, mobile apps, custom software, cloud integration, and enterprise solutions.",
  keywords: [
