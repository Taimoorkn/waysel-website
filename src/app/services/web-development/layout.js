export const metadata = {
  ...
  description:
    "Professional web development services including frontend, backend, full-stack development, and e-commerce solutions. Build responsive, scalable websites.",
  keywords: [
  ...
  openGraph: {
    title: "Web Development Services - TechiTech Solutions",
    description:
      "Professional web development services including frontend, backend, full-stack development, and e-commerce solutions.",
    type: "website",
