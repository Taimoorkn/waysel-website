...
const SuccessStories = ({ type }) => {
 ...
 <h3 className="font-neueMontreal text-[28px] lg:text-[38px] text-primary_text font-medium">
 {story.title}
 </h3>
 <Button
 variant="secondary"
 ...
 <p className="font-neueMontreal text-sm sm:text-base text-secondary_text mx-4 sm:mx-6 mb-6 sm:mb-8 text-justify">
 {story.description}
 </p>
 </div>
 ))}
