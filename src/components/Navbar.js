...
const Navbar = () => {
 ...
 height={40}
 />
 <span className="text-lg xl:text-2xl text-accent font-neueMontreal">
 TechiTech Solutions
 </span>
 </Link>
 ...
 <ul className="flex items-center space-x-4 font-neueMontreal text-sm font-medium text-primary_text h-[4.5rem]">
 ...
 >
 <div className="p-4">
 <ul className="flex flex-col gap-2 font-neueMontreal text-[12.5px] font-medium text-primary_text mb-6">
