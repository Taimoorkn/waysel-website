  ...
  return (
    <div className={bannerStyles} {...props}>
      <div className="relative w-full min-h-full bg-accent rounded-3xl pt-6 sm:pt-8 lg:pt-11 pb-6 sm:pb-8 lg:pb-8 gap-3 sm:gap-4 flex flex-col items-center justify-center text-white overflow-hidden">
        ...
        {/* Content */}
        <h2 className="font-clashGrotesk text-xl sm:text-2xl lg:text-[42px] leading-tight sm:leading-[40px] lg:leading-[51.7px] font-semibold text-center px-4 sm:px-0 relative z-10">
          {heading}
        </h2>
        <p className="font-manrope text-sm sm:text-base lg:text-lg leading-snug sm:leading-[24px] text-center px-4 sm:px-0 relative z-10">
          {description}
        </p>
