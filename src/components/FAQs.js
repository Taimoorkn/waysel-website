        ...
        faqs.map((item, index) => (
          ...
          >
            <AccordionHeader
              ...
              className={`px-4 sm:px-6 lg:px-9 py-4 sm:py-6 text-left font-manrope text-xs sm:text-base leading-tight sm:leading-[22px] text-primary_text transition-colors 
