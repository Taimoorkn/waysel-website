...
const TechStack = ({ techToDisplay }) => {
 ...
 const categories = ["All", "Frontend", "Backend", "Database", "DevOps", "Cloud", "UX/UI", "Other"];
 ...
 return (
 <section className="bg-primary_bg px-4 2xl:px-[9.5rem] py-10 text-center">
 ...
 <button
 key={category}
 className={`text-primary-text px-4 sm:px-6 py-2 sm:py-3 font-semibold text-sm sm:text-[16px] rounded-lg 
 ...
 <div
 key={index}
 className="tech_stack_icon sm:max-w-[10.196%] font-neueMontreal gap-[6px] text-[15px]"
 >
 {item.logo}
