const ServiceBox = ({ title, description, image }) => {
  return (
    <div className="flex w-full flex-col items-start justify-start rounded-xl bg-white px-8 py-10 shadow-[0_5px_64px_rgba(0,0,0,0.08)] md:w-[calc(33.33333333%_-_21.33333333px)]">
      <div className="mb-6">
