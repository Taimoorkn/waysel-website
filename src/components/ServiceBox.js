const ServiceBox = ({ title, description, image }) => {
 ...
 <h3 className="font-neueMontreal text-lg sm:text-xl md:text-2xl text-primary_text font-medium mb-2 sm:mb-3">
 {title}
 </h3>
 <p className="font-neueMontreal text-sm sm:text-base md:text-lg text-tertiary_text text-justify">
 {description}
 </p>
 </div>
 );
